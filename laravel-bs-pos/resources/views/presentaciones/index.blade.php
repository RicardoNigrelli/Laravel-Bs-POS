                                    ...
                                    @foreach($presentaciones as $presentacione)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($presentacione->caracteristica->estado == 1)                                                
                                                <button type="button" class="btn btn-danger" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$presentacione->id}}">>Eliminar</button>
                                                @else
                                                <button type="button" class="btn btn-success" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$presentacione->id}}">>Restaurar</button>
                                                @endif
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                {{ $presentacione->caracteristica->estado == 1 ? "¿Desea eliminar la presentacion {$presentacione->caracteristica->nombre}?" : "¿Desea restaurar la presentacion {$presentacione->caracteristica->nombre}?" }}
